...
// Crear arr50 de 50 números reales aleatorios
let arr50 = [];
for (let i = 0; i < 50; i++) {
...
// Ordenar arr50 de menor a mayor
...
// Copiar los primeros 10 números ordenados de arr50 a arr20
arr20 = arr50.slice(0, 10);

// Rellenar los últimos 10 elementos de arr20 con el valor 0.5
for (let i = 0; i < 10; i++) {
    arr20.push(0.5);
}

// Mostrar arr50 ordenado
console.log("Array A ordenado:");
console.log(arr50);

// Mostrar arr20 resultante
